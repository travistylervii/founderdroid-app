const PrivacyPolicyPage = () => {
  return (
    <div className="container mx-auto">
      ...
      <h2>Introduction</h2>
      <p>
        Welcome to api.founderdroid.com. This Privacy Policy explains how we
        collect, use, disclose, and safeguard your information when you use our
        API. We respect your privacy and are committed to protecting your
        personal data.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Personal Data:</strong> While using our API, we may ask you to
          ...
          information may include, but is not limited to, your email address and
          name.
        </li>
      </ul>
      ...
      <ul>
        <li>To provide and maintain our API</li>
        <li>To notify you about changes to our API</li>
        <li>
          To allow you to participate in interactive features of our API when
          you choose to do so
        </li>
        ...
        <li>To monitor the usage of our API</li>
      ...
      <p>
        ...
        described in this Privacy Policy. We may share your personal information
        with:
      </p>
      <ul>
      ...
      <p>
        ...
        at travis+apisupport@mooremediallc.com.
      </p>
    </div>
  );
};
